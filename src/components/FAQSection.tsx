...
const FAQSection = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Базовый пакет документов: Справка о периоде обучения (заказывается в колледже) + паспорт, ИНН и СНИЛС. Полный список документов мы предоставим после консультации, так как он может варьироваться в зависимости от конкретной ситуации."
    },
    {
    ...
    },
    {
      ...
      answer: "Нельзя. После получения диплома колледжа можно только поступать в вуз. Но сразу после диплома колледжа отсрочка от срочной службы в армии по образованию сгорает навсегда."
    },
    {
      question: "Гарантируете ли вы результат?",
      answer: "Да, мы гарантируем результат, но нужно успеть произвести перевод до получения диплома колледжа."
    },
    {
