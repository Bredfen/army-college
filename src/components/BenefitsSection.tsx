...
const BenefitsSection = () => {
  const benefits = [
    ...
    },
    {
      ...
      title: "Опыт",
      description: "Сотни успешно проведённых переводов студентов."
    },
    {
    ...
    },
    {
      ...
      title: "Результат",
      description: "Гарантируем положительный результат или возврат средств."
    }
  ]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Мы специализируемся именно на решении вопросов отсрочки от армии 
            и знаем все тонкости законодательства
          </p>
        </div>
